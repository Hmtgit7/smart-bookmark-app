            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    <p className="text-muted-foreground text-base sm:text-lg px-4">
                        AI-powered features designed for effortless organization
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                    <FeatureCard
                        ...
                        description="Automatically generate tags, categories, and descriptions with AI"
                    />
                    <FeatureCard
                        icon={<Tags className="h-5 w-5 sm:h-6 sm:w-6" />}
                        title="Smart Tags"
                        description="Organize bookmarks with custom tags for quick filtering and discovery"
                    />
                    {/* <FeatureCard
